-- Fix the RETURN statement issue in select_and_reserve_game_questions function
...
BEGIN
  ...
  LOOP
    ...
    VALUES (p_game_id, v_question_record.selected_question_id, v_order_counter);
    ...
    VALUES (v_question_record.selected_question_id, 1, NOW(), NOW())
    ...
    -- Return the question info using local variables
    v_question_id := v_question_record.selected_question_id;
    v_question_order := v_order_counter;
